...
- Tests live in: `TODO` — spec defines `hermes-portfolio-manager/tests/` with test_config.py, test_worktree.py, test_summary.py, test_tools.py. No test files exist yet.
...
- Anthropic's official Claude Code best practices (explore-plan-code-commit, verification loops, context as the resource).
